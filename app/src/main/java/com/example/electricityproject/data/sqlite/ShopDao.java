...
public class ShopDao extends AbstractDao<Shop, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ShopInfo = new Property(1, String.class, "shopInfo", false, "SHOP_INFO");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Shop entity) {
        ...
        String shopInfo = entity.getShopInfo();
        if (shopInfo != null) {
            stmt.bindString(2, shopInfo);
        }
    }
    ...
    public Shop readEntity(Cursor cursor, int offset) {
        Shop entity = new Shop( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // shopInfo
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Shop entity, int offset) {
        ...
        entity.setShopInfo(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
